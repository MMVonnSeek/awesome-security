...
- [Linux Security Guide](https://github.com/MMVonnSeek/linux-security-guide) - Practical hands-on guide to Linux security covering permissions, process analysis, networking, nftables firewall, SSH hardening, log auditing and persistence detection via cron. Includes labs with solutions. (pt-BR)
